  ...
  return (
    <header className="bg-white shadow-md rounded-xl mt-2 mx-3 p-2 relative z-50 max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        ...
        <div>
          <Link to="/signin">
            <button className="w-24 h-10 rounded-2xl cursor-pointer font-semibold bg-[#7FC68A] hover:bg-black text-black hover:text-white transition-colors duration-300">
              Login
            </button>
          </Link>
        </div>
